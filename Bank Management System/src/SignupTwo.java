...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        JLabel addtitionalDetails = new JLabel("Page 2: Additional Details");
        addtitionalDetails.setFont(new Font("Raleway", Font.BOLD, 22));
        addtitionalDetails.setBounds(290, 80, 400, 30);
        add(addtitionalDetails);

        JLabel name = new JLabel("Relgion:");
        ...
        next.setFont(new Font("Ralewar", Font.BOLD, 14));
